				...
				var vm=new Vue({
					...
					methods:{
						add:function(){
							...
							postJSON('<%=basePath+"kbms/addresource"%>',{"user_id":<%=session.getAttribute("user_id")%>,"domain":this.domain
...
<div style="width:1000px">
	<form id="form">
        ...
        <button type="button" class="btn btn-primary btn-lg btn-block" v-on:click="add">确认添加</button>	
        </div>
	</form>
</div>
